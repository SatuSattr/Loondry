...
<head>
    ...
    <title>Verifikasi Email - Loondry</title>
    <!--[if mso]>
    <noscript>
    <xml>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 570px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(15, 23, 42, 0.03); border: 1px solid #e2e8f0;">
                    ...
                    <tr>
                        <td class="content-padding" style="padding: 32px 48px 40px 48px; text-align: left;">
                            <h2 class="welcome-text" style="margin: 0 0 16px 0; color: #0f172a; font-size: 28px; font-weight: 700; letter-spacing: -0.03em;">Verifikasi Email Anda</h2>
                            
                            <p style="margin: 0 0 16px 0; font-size: 16px; color: #334155;">Halo <strong>{{ $user->name }}</strong>,</p>
                            <p style="margin: 0 0 32px 0; font-size: 15px; color: #64748b; line-height: 1.7;">Terima kasih telah bergabung dengan Loondry. Silakan klik tombol di bawah ini untuk memverifikasi alamat email Anda agar dapat menikmati semua fitur pelacakan laundry kami:</p>
                            
                            <!-- Call to Action Button -->
                            <div style="text-align: center; margin: 32px 0;">
                                <!--[if mso]>
                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $url }}" style="height:48px;v-text-anchor:middle;width:200px;" arcsize="17%" stroke="f" fillcolor="#0284c7">
                                    <w:anchorlock/>
                                    <center style="color:#ffffff;font-family:sans-serif;font-size:15px;font-weight:bold;">Verifikasi Email</center>
                                </v:roundrect>
                                <![endif]-->
                                <!--[if !mso]><!-->
                                <a href="{{ $url }}" style="background-color: #0284c7; color: #ffffff; padding: 12px 32px; border-radius: 8px; text-decoration: none; font-weight: 700; display: inline-block; font-size: 15px; box-shadow: 0 4px 12px rgba(2, 132, 199, 0.15); transition: background-color 0.2s ease;">Verifikasi Email</a>
                                <!--<![endif]-->
                            </div>

                            <!-- Context / Information Advisory Notice -->
                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin-bottom: 32px;">
                                <tr>
                                    <td style="font-size: 13px; color: #64748b; line-height: 1.5; background-color: #f8fafc; border-left: 3px solid #cbd5e1; padding: 12px 16px; border-radius: 0 8px 8px 0;">
                                        👉 <strong>Belum melakukan pendaftaran?</strong> Jika Anda tidak merasa mendaftarkan akun di platform aplikasi Loondry, Anda cukup mengabaikan email ini dengan aman.
                                    </td>
                                </tr>
                            </table>

                            <!-- Help Center Support Line -->
                            <div style="margin-top: 32px; padding-top: 20px; border-top: 1px dashed #e2e8f0; text-align: center;">
                                <p style="margin: 0; font-size: 12px; color: #94a3b8; line-height: 1.6;">
                                    Mengalami kendala saat melakukan konfirmasi akun? Balas pesan ini untuk terhubung langsung dengan tim support kami.
                                </p>
                            </div>
                        </td>
                    </tr>
