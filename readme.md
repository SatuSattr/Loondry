...
| Apps | Path | Stack |
|------|------|-------|
| **REST API** | [`apps/api`](apps/api/) | Laravel + Sanctum |
| **Web Admin** | [`apps/dashboard`](apps/dashboard/) | Vite + React + shadcn/ui |
| **Mobile App** | [`apps/mobile`](apps/mobile/) | Expo + React Native |
